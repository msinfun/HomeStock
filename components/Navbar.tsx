...
const Navbar: React.FC<NavbarProps> = ({ activeView, setActiveView, onAddClick }) => {
  return (
    <nav
      ...
      className="fixed bottom-8 left-6 right-6 max-w-[416px] mx-auto bg-white/80 backdrop-blur-[40px] backdrop-saturate-150 rounded-full flex justify-around items-center h-[72px] z-50 transition-all duration-500 border border-white/40 shadow-[0_20px_40px_rgba(0,0,0,0.08),inset_0_2px_2px_rgba(255,255,255,1),inset_0_-1px_1px_rgba(255,255,255,0.2)] px-2"
    >
